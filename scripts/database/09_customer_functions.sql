...
DROP FUNCTION IF EXISTS agent_swarm.add_customer(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS agent_swarm.update_customer;
DROP FUNCTION IF EXISTS agent_swarm.get_followup_customers(INTEGER);

-- Function: Add a new customer
-- Creates entity, contact, address, and relationship records atomically
CREATE OR REPLACE FUNCTION agent_swarm.add_customer(
    p_first_name TEXT,
    p_last_name TEXT,
    p_email TEXT,
    p_phone TEXT,
...
CREATE OR REPLACE FUNCTION agent_swarm.update_customer(
    p_search_name TEXT,
...
CREATE OR REPLACE FUNCTION agent_swarm.get_followup_customers(p_days_threshold INTEGER DEFAULT 7)
RETURNS TABLE(
    entity_id INTEGER,
    name TEXT,
    email TEXT,
